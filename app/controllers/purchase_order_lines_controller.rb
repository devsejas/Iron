class PurchaseOrderLinesController < ApplicationController
  ...
  private
    ...
    def purchase_order_lines_params
      params.require(:purchase_order_lines).permit(:id, :name, :item_qty, :date_planned, :item_id, :price_unit, :price_tax, :company_id, :state, :qty_received, :purchase_order_id, :_destroy)
    end
end
